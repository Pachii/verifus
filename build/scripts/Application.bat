...
set CLASSPATH=%APP_HOME%\lib\Application.jar;%APP_HOME%\lib\JDA-3.8.1_450.jar;%APP_HOME%\lib\shadow-4.0.3.jar;%APP_HOME%\lib\log4j-core-2.11.1.jar;%APP_HOME%\lib\mysql-connector-java-8.0.13.jar;%APP_HOME%\lib\slf4j-simple-1.7.25.jar;%APP_HOME%\lib\jda-utilities-examples-2.1.5.jar;%APP_HOME%\lib\jda-utilities-command-2.1.5.jar;%APP_HOME%\lib\slf4j-api-1.7.25.jar;%APP_HOME%\lib\commons-lang3-3.8.1.jar;%APP_HOME%\lib\stripe-java-7.17.0.jar;%APP_HOME%\lib\jda-utilities-menu-2.1.5.jar;%APP_HOME%\lib\jsr305-3.0.2.jar;%APP_HOME%\lib\annotations-16.0.1.jar;%APP_HOME%\lib\nv-websocket-client-2.5.jar;%APP_HOME%\lib\okhttp-3.12.0.jar;%APP_HOME%\lib\opus-java-1.0.4.pom;%APP_HOME%\lib\commons-collections4-4.1.jar;%APP_HOME%\lib\json-20160810.jar;%APP_HOME%\lib\trove4j-3.0.3.jar;%APP_HOME%\lib\jda-utilities-doc-2.1.5.jar;%APP_HOME%\lib\jda-utilities-commons-2.1.5.jar;%APP_HOME%\lib\groovy-backports-compat23-2.4.15.jar;%APP_HOME%\lib\log4j-api-2.11.1.jar;%APP_HOME%\lib\protobuf-java-3.6.1.jar;%APP_HOME%\lib\gson-2.8.5.jar;%APP_HOME%\lib\okio-1.15.0.jar;%APP_HOME%\lib\opus-java-api-1.0.4.jar;%APP_HOME%\lib\opus-java-natives-1.0.4.jar;%APP_HOME%\lib\jna-4.4.0.jar
